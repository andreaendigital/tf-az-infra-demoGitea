...
[mysql]
vm-mysql-azure ansible_host=${env.MYSQL_VM_PRIVATE_IP} ansible_user=azureuser ansible_ssh_private_key_file=~/.ssh/azure-gitea-key.pem
                ...
                withCredentials([
                    ...
                    sshagent(credentials: ['azure-ssh-key']) {
                        sh """
                            ...
                            # Run Ansible playbook with MySQL root password as extra-vars
